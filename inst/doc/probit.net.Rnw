...
\SweaveOpts{results=hide, prefix.string=vigpics/probitnet}
...
%\VignetteIndexEntry{Network Probit Regression for Dichotomous Proximity Matrix Dependent Variables}
